...
from model.ConvolutionalNeuralNet import ConvolutionalNeuralNet
...
# Create datasets
train_dataset, validation_dataset = model.create_datasets(
    train_image_paths, test_image_paths, classes
)

# Get results from training
results_dict = model.train_k_fold(
    train_dataset, validation_dataset, num_epochs=30, num_folds=5
)
...
# Create a list of validation losses mean and validation accuracy mean per eposch at each fold
